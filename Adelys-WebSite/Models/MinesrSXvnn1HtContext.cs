...
public partial class MinesrSXvnn1HtContext : DbContext
{
    public MinesrSXvnn1HtContext()
    {
    }

    public MinesrSXvnn1HtContext(DbContextOptions<MinesrSXvnn1HtContext> options)
        : base(options)
    {
    }
